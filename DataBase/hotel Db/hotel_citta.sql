...
CREATE TABLE `citta` (
  ...
  CONSTRAINT `NAZ` FOREIGN KEY (`ID_NAZ`) REFERENCES `nazione` (`ID_NAZ`),
  CONSTRAINT `PROV` FOREIGN KEY (`ID_PROV`) REFERENCES `provincia` (`ID_PROV`)
...
-- Dump completed on 2023-05-21 11:26:58
